...
public class PermissaoNaoEncontradaException extends EntidadeNaoEncontradaException /*ResponseStatusException */{
	...
	public PermissaoNaoEncontradaException(Long classId) {
